// lib/ledLayout/computeExactLedGrid.ts
 ...
 * This function does not ignore the LEDs, it therefore allows for the creation of unusual layouts for a prime numbers.
 ...
 */
export default function computeExactLedGrid(
    imageWidth: number,
    imageHeight: number,
    totalLeds: number,
): LedGrid {
